	...
	<div class="table-cell line-content wpeo-form">
		...
		<div class="libelle form-element <?php echo esc_attr( ! empty( $line->line_status ) && ( false === $line->line_status['status'] ) && in_array( 'title', $line->line_status['errors'], true ) ? 'input-error' : '' ); ?>">
			...
			<label class="form-field-container">
				<input type="text" class="form-field" name="line-title" placeholder="<?php esc_attr_e( 'Label', 'frais-pro' ); ?>" value="<?php echo esc_html( $line->title ); ?>" <?php echo ( $note_is_closed ? 'readonly="readonly"' : '' ); ?>/>
			</label>
		</div>
		<!-- Date -->
		<div class="form-element date group-date">
			...
			<label class="form-field-container">
				...
				<input type="text" class="mysql-date" name="line-date" value="<?php echo esc_attr( $line->date['raw'] ); ?>" <?php echo ( $note_is_closed ? 'readonly="readonly"' : '' ); ?>/>
		...
		<div class="ttc form-element <?php echo esc_attr( ! empty( $line->line_status ) && ( false === $line->line_status['status'] ) && in_array( 'amount', $line->line_status['errors'], true ) ? 'input-error' : '' ); ?>">
			...
			<label class="form-field-container">
				<input type="text" class="form-field" name="line-tax_inclusive_amount" value="<?php echo esc_html( $line->tax_inclusive_amount ); ?>" <?php echo ( $note_is_closed ? 'readonly="readonly"' : '' ); ?>/>
			</label>
		</div>
		<!-- TVA -->
		<div class="tva form-element <?php echo esc_attr( ! empty( $line->line_status ) && ( false === $line->line_status['status'] ) && in_array( 'amount', $line->line_status['errors'], true ) ? 'input-error' : '' ); ?>">
			...
			<label class="form-field-container">
				<input type="text" class="form-field" name="line-tax_amount" value="<?php echo esc_html( $line->tax_amount ); ?>" <?php echo ( $note_is_closed ? 'readonly="readonly"' : '' ); ?> />
			</label>
		</div>
		<!-- Status -->
