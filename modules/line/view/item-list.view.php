...
<ul class="row" data-i="<?php echo esc_attr( $i ); ?>"<?php echo esc_attr( ! empty( $ndfl ) && ! empty( $ndfl->current_category ) && ! empty( $ndfl->current_category->special_treatment ) ? ' special_treatment=' . $ndfl->current_category->special_treatment : '' ); ?>>
	...
	<li class="libelle<?php echo esc_attr( ! empty( $line_status ) && ( false === $line_status['status'] ) && in_array( 'title', $line_status['errors'], true ) ? ' ndfl-input-error' : '' ); ?>" data-title="<?php esc_attr_e( 'Name', 'frais-pro' ); ?>"><span contenteditable="<?php echo esc_attr( $ndf_is_closed ? 'false' : 'true' ); ?>" data-name="row[<?php echo esc_attr( $i ); ?>][title]"><?php echo esc_html( $ndfl->title ); ?></span></li>
	<li class="type toggle list<?php echo esc_attr( ! empty( $line_status ) && ( false === $line_status['status'] ) && in_array( 'category', $line_status['errors'], true ) ? ' ndfl-input-error' : '' ); ?>" data-parent="toggle" data-target="content" data-title="<?php esc_attr_e( 'Line type', 'frais-pro' ); ?>">
	...
	<li class="ttc<?php echo esc_attr( ! empty( $line_status ) && ( false === $line_status['status'] ) && in_array( 'amount', $line_status['errors'], true ) ? ' ndfl-input-error' : '' ); ?>" data-title="<?php esc_attr_e( 'ATI (€)', 'frais-pro' ); ?>"><span contenteditable="<?php echo esc_attr( $ndf_is_closed ? 'false' : 'true' ); ?>" data-name="row[<?php echo esc_attr( $i ); ?>][tax_inclusive_amount]" ><?php echo esc_html( $ndfl->tax_inclusive_amount ); ?></span></li>
	<li class="tva<?php echo esc_attr( ! empty( $line_status ) && ( false === $line_status['status'] ) && in_array( 'amount', $line_status['errors'], true ) ? ' ndfl-input-error' : '' ); ?>" data-title="<?php esc_attr_e( 'Recoverable VAT', 'frais-pro' ); ?>"><span contenteditable="<?php echo esc_attr( $ndf_is_closed ? 'false' : 'true' ); ?>" data-name="row[<?php echo esc_attr( $i ); ?>][tax_amount]" ><?php echo esc_html( $ndfl->tax_amount ); ?></span></li>
	<li class="photo" data-title="<?php esc_attr_e( 'Picture', 'frais-pro' ); ?>"><?php do_shortcode( '[wpeo_upload id="' . $ndfl->id . '" field_name="thumbnail_id" model_name="/frais_pro/Line_Class" single="true" ]' ); ?></li>
