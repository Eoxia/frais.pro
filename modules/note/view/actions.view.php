...
<div class="wpeo-dropdown dropdown-right" >
	...
	<ul class="dropdown-content" >
		<li class="dropdown-item action-attribute"
			...
			data-picture="1"><i class="icon far fa-sync-alt"></i>&nbsp;<?php esc_html_e( 'With picture', 'frais-pro' ); ?></li>
		<li class="dropdown-item action-attribute"
			data-id="<?php echo esc_attr( $note->id ); ?>"
			data-action="fp_export_note"
			data-type="odf"
			data-nonce="<?php echo esc_attr( wp_create_nonce( 'fp_export_note' ) ); ?>"
			data-picture="0"><i class="icon far fa-sync-alt"></i>&nbsp;<?php esc_html_e( 'Without picture', 'frais-pro' ); ?></li>
		<li class="dropdown-item action-attribute"
			data-id="<?php echo esc_attr( $note->id ); ?>"
			data-action="fp_export_note"
			data-type="csv"
			data-nonce="<?php echo esc_attr( wp_create_nonce( 'fp_export_note' ) ); ?>"><i class="icon far fa-sync-alt"></i>&nbsp;<?php esc_html_e( 'CSV export', 'frais-pro' ); ?></li>
	</ul>
</div>
<div class="wpeo-dropdown dropdown-right" >
	...
	<ul class="dropdown-content" >
		<li class="dropdown-item action-attribute"
			...
			data-picture="1"><i class="icon far fa-arrow-to-bottom"></i>&nbsp;<?php esc_html_e( 'With picture', 'frais-pro' ); ?></li>
		<li class="dropdown-item action-attribute"
			data-id="<?php echo esc_attr( $note->id ); ?>"
			data-action="download_export"
			data-nonce="<?php echo esc_attr( wp_create_nonce( 'download_export' ) ); ?>"
			data-picture="0"><i class="icon far fa-arrow-to-bottom"></i>&nbsp;<?php esc_html_e( 'Without picture', 'frais-pro' ); ?></li>
		<li class="dropdown-item action-attribute"
			data-id="<?php echo esc_attr( $note->id ); ?>"
			data-action="download_export"
			data-nonce="<?php echo esc_attr( wp_create_nonce( 'download_export' ) ); ?>"><i class="icon far fa-arrow-to-bottom"></i>&nbsp;<?php esc_html_e( 'CSV export', 'frais-pro' ); ?></li>
	</ul>
</div>
<div class="wpeo-dropdown dropdown-right" >
	...
	<ul class="dropdown-content" >
		<li class="dropdown-item action-attribute"
			...
			data-nonce="<?php echo esc_attr( wp_create_nonce( 'fp_note_archive' ) ); ?>"><i class="icon fas fa-archive"></i>&nbsp;<?php esc_html_e( 'Archive', 'frais-pro' ); ?></li>
	</ul>
</div>
