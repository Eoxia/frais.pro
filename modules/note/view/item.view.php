...
<tr class="note" style="border-left-color:<?php echo esc_html( $note['current_status']->data['color'] ); ?>" data-link="<?php echo esc_url( admin_url( 'admin.php?page=frais-pro-edit' ) ); ?>&note=<?php echo esc_attr( $note['id'] ); ?>" data-id="<?php echo esc_attr( $note['id'] ); ?>" >
	<td class="note-status" >
		<span class="status-label">
		<?php if ( 'archive' !== $note['status'] ) : ?>
			<?php echo esc_html( $note['current_status']->data['name'] ); ?>
		<?php else : ?>
