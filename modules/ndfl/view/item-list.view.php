...
<ul class="row" data-i="<?php echo esc_attr( $i ); ?>"<?php echo esc_attr( ! empty( $ndfl ) && ! empty( $ndfl->current_category ) && ! empty( $ndfl->current_category->special_treatment ) ? ' special_treatment=' . $ndfl->current_category->special_treatment : '' ); ?>>
	...
	<li class="libelle" data-title="<?php esc_attr_e( 'Name', 'frais-pro' ); ?>"><span contenteditable="true" data-name="row[<?php echo esc_attr( $i ); ?>][title]"><?php echo esc_html( $ndfl->title ); ?></span></li>
	...
	<li class="km" data-title="<?php esc_attr_e( 'Km', 'frais-pro' ); ?>"><span contenteditable="true" data-name="row[<?php echo esc_attr( $i ); ?>][distance]" ><?php echo esc_html( $ndfl->distance ); ?></span></li>
	<li class="ttc" data-title="<?php esc_attr_e( 'ATI (€)', 'frais-pro' ); ?>"><span contenteditable="true" data-name="row[<?php echo esc_attr( $i ); ?>][tax_inclusive_amount]" ><?php echo esc_html( $ndfl->tax_inclusive_amount ); ?></span></li>
	<li class="tva" data-title="<?php esc_attr_e( 'Recoverable VAT', 'frais-pro' ); ?>"><span contenteditable="true" data-name="row[<?php echo esc_attr( $i ); ?>][tax_amount]" ><?php echo esc_html( $ndfl->tax_amount ); ?></span></li>
	<li class="photo" data-title="<?php esc_attr_e( 'Picture', 'frais-pro' ); ?>"><?php do_shortcode( '[wpeo_upload id="' . $ndfl->id . '" field_name="thumbnail_id" model_name="/note_de_frais/ndfl_class" single="true" mime_type="image" ]' ); ?></li>
