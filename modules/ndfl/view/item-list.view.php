...
<ul class="row" data-i="<?php echo esc_attr( $i ); ?>"<?php echo esc_attr( ! empty( $ndfl ) && ! empty( $ndfl->current_category ) && ! empty( $ndfl->current_category->special_treatment ) ? ' special_treatment=' . $ndfl->current_category->special_treatment : '' ); ?>>
	...
	<li class="type toggle list<?php echo esc_attr( ! empty( $line_status ) && ( false === $line_status['status'] ) && in_array( 'category_name', $line_status['errors'], true ) ? ' ndfl-input-error' : '' ); ?>" data-parent="toggle" data-target="content" data-title="<?php esc_attr_e( 'Line type', 'frais-pro' ); ?>">
	...
	<li class="ttc<?php echo esc_attr( ! empty( $line_status ) && ( false === $line_status['status'] ) && in_array( 'tax_inclusive_amount', $line_status['errors'], true ) ? ' ndfl-input-error' : '' ); ?>" data-title="<?php esc_attr_e( 'ATI (€)', 'frais-pro' ); ?>"><span contenteditable="<?php echo esc_attr( $ndf_is_closed ? 'false' : 'true' ); ?>" data-name="row[<?php echo esc_attr( $i ); ?>][tax_inclusive_amount]" ><?php echo esc_html( $ndfl->tax_inclusive_amount ); ?></span></li>
	<li class="tva<?php echo esc_attr( ! empty( $line_status ) && ( false === $line_status['status'] ) && in_array( 'tax_amount', $line_status['errors'], true ) ? ' ndfl-input-error' : '' ); ?>" data-title="<?php esc_attr_e( 'Recoverable VAT', 'frais-pro' ); ?>"><span contenteditable="<?php echo esc_attr( $ndf_is_closed ? 'false' : 'true' ); ?>" data-name="row[<?php echo esc_attr( $i ); ?>][tax_amount]" ><?php echo esc_html( $ndfl->tax_amount ); ?></span></li>
