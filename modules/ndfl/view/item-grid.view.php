...
<ul class="row<?php echo esc_attr( ! empty( $line_status ) && ( false === $line_status['status'] ) ? ' ndfl-error' : '' ); ?>" data-i="<?php echo esc_attr( $i ); ?>"<?php echo esc_attr( ! empty( $ndfl ) && ! empty( $ndfl->current_category ) && ! empty( $ndfl->current_category->special_treatment ) ? ' special_treatment=' . $ndfl->current_category->special_treatment : '' ); ?>>
	...
	<div class="gridwrapper w2">
		...
		<div>
			...
			<li class="ttc<?php echo esc_attr( ! empty( $line_status ) && ( false === $line_status['status'] ) && in_array( 'amount', $line_status['errors'], true ) ? ' ndfl-input-error' : '' ); ?>" data-title="<?php esc_attr_e( 'ATI (€)', 'frais-pro' ); ?>">
			...
			<li class="tva<?php echo esc_attr( ! empty( $line_status ) && ( false === $line_status['status'] ) && in_array( 'amount', $line_status['errors'], true ) ? ' ndfl-input-error' : '' ); ?>" data-title="<?php esc_attr_e( 'Recoverable VAT', 'frais-pro' ); ?>">
